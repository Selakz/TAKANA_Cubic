...
namespace T3Framework.Static.Easing
{
	...
	public static class EasesExtension
	{
		...
		public static float CalcCoord(this Eases e, float left, float right, float t)
		{
			return e switch
			{
				Eases.Unmove => CurveCalculator.EaseStill(left, right, t),
				Eases.Linear => CurveCalculator.EaseLinear(left, right, t),
				Eases.InSine => CurveCalculator.EaseInSine(left, right, t),
				Eases.OutSine => CurveCalculator.EaseOutSine(left, right, t),
				Eases.InOutSine => CurveCalculator.EaseInOutSine(left, right, t),
				Eases.OutInSine => CurveCalculator.EaseOutInSine(left, right, t),
				Eases.InQuad => CurveCalculator.EaseInQuad(left, right, t),
				Eases.OutQuad => CurveCalculator.EaseOutQuad(left, right, t),
				Eases.InOutQuad => CurveCalculator.EaseInOutQuad(left, right, t),
				Eases.OutInQuad => CurveCalculator.EaseOutInQuad(left, right, t),
				Eases.InCubic => CurveCalculator.EaseInCubic(left, right, t),
				Eases.OutCubic => CurveCalculator.EaseOutCubic(left, right, t),
				Eases.InOutCubic => CurveCalculator.EaseInOutCubic(left, right, t),
				Eases.OutInCubic => CurveCalculator.EaseOutInCubic(left, right, t),
				Eases.InQuart => CurveCalculator.EaseInQuart(left, right, t),
				Eases.OutQuart => CurveCalculator.EaseOutQuart(left, right, t),
				Eases.InOutQuart => CurveCalculator.EaseInOutQuart(left, right, t),
				Eases.OutInQuart => CurveCalculator.EaseOutInQuart(left, right, t),
				Eases.InQuint => CurveCalculator.EaseInQuint(left, right, t),
				Eases.OutQuint => CurveCalculator.EaseOutQuint(left, right, t),
				Eases.InOutQuint => CurveCalculator.EaseInOutQuint(left, right, t),
				Eases.OutInQuint => CurveCalculator.EaseOutInQuint(left, right, t),
				Eases.InExpo => CurveCalculator.EaseInExpo(left, right, t),
				Eases.OutExpo => CurveCalculator.EaseOutExpo(left, right, t),
				Eases.InOutExpo => CurveCalculator.EaseInOutExpo(left, right, t),
				Eases.OutInExpo => CurveCalculator.EaseOutInExpo(left, right, t),
				Eases.InCirc => CurveCalculator.EaseInCirc(left, right, t),
				Eases.OutCirc => CurveCalculator.EaseOutCirc(left, right, t),
				Eases.InOutCirc => CurveCalculator.EaseInOutCirc(left, right, t),
				Eases.OutInCirc => CurveCalculator.EaseOutInCirc(left, right, t),
				Eases.InBack => CurveCalculator.EaseInBack(left, right, t),
				Eases.OutBack => CurveCalculator.EaseOutBack(left, right, t),
				Eases.InOutBack => CurveCalculator.EaseInOutBack(left, right, t),
				Eases.OutInBack => CurveCalculator.EaseOutInBack(left, right, t),
				Eases.InElastic => CurveCalculator.EaseInElastic(left, right, t),
				Eases.OutElastic => CurveCalculator.EaseOutElastic(left, right, t),
				Eases.InOutElastic => CurveCalculator.EaseInOutElastic(left, right, t),
				Eases.OutInElastic => CurveCalculator.EaseOutInElastic(left, right, t),
				Eases.InBounce => CurveCalculator.EaseInBounce(left, right, t),
				Eases.OutBounce => CurveCalculator.EaseOutBounce(left, right, t),
				Eases.InOutBounce => CurveCalculator.EaseInOutBounce(left, right, t),
				Eases.OutInBounce => CurveCalculator.EaseOutInBounce(left, right, t),
				_ => throw new ArgumentOutOfRangeException(nameof(e), e, null)
			};
		}
	}
