...
namespace Takana3.Settings
{
	public class EditorGlobalSetting
	{
		...
		[DefaultValue(100)] public int HitSoundVolumePercent { get; set; } = 100;
		...
		[DefaultValue(1)]
		public int AutoSaveInterval_Minute { get; set; } = 1;
		...
		[DefaultValue(3000)]
		public int InitialTrackLength_Ms { get; set; } = 3000;

		/// <summary> 设置是否 </summary>
		[DefaultValue(false)]
		public bool IsReverseCurveName { get; set; } = false;
