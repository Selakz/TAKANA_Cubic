...
{
	public class SlideController : BaseNoteController<Slide>
	{
		...
		void OnEnable()
		{
			...
			ScaleModifier.Register(
				_ =>
				{
					...
					var slideTrackGap = ISingletonSetting<PlayfieldSetting>.Instance.TrackGap2;
					return new(width > 2 * slideTrackGap ? width - slideTrackGap : width, 0);
				},
				0);
		}
