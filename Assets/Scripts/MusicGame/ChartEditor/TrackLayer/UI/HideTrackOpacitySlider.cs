...
{
	public class HideTrackOpacitySlider : MonoBehaviour
	{
		...
		private int TrackOpacityPercent
		{
			set
			{
				ISingletonSetting<TrackLayerSetting>.Instance.UnselectLayerOpacityRatio.Value = value / 100f;
		...
		private void LevelOnLoad(LevelInfo levelInfo)
		{
			...
			var alpha = ISingletonSetting<TrackLayerSetting>.Instance.UnselectLayerOpacityRatio;
