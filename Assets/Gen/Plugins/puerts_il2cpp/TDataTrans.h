...
public:
    ...
    ~AutoValueScope()
    {
        ...
        {
            auto apis = _apis;
            apis->close_scope_placement(_scope);
        }
    }
...
struct DataTransfer
{
    ...
    static pesapi_value CopyValueType(struct pesapi_ffi* apis, pesapi_env env, const Il2CppClass* type_id, const void* ptr, size_t size)
    {
        ...
        {
            Il2CppObject* obj = il2cpp::vm::Object::Box(const_cast<Il2CppClass *>(type_id), const_cast<void*>(ptr));
    ...
    static Il2CppObject* GetValueTypeForCSharp(const Il2CppClass* type_id, const void* jsPtr)
    {
        return (type_id->has_references) ? (Il2CppObject*)((((char*)jsPtr) - sizeof(Il2CppObject))) : il2cpp::vm::Object::Box(const_cast<Il2CppClass*>(type_id), const_cast<void*>(jsPtr));
    }
    ...
    static pesapi_value CopyNullableValueType(struct pesapi_ffi* apis, pesapi_env env, const T &v, const Il2CppClass* type_id)
    {
        ...
        return CopyValueType(apis, env, v.p1, il2cpp::vm::Class::GetNullableArgument(type_id));
    }
};
...
struct BridgeFuncInfo
{
    ...
    InvokerMethod Invoker; //typedef void (*InvokerMethod)(Il2CppMethodPointer, const MethodInfo*, void*, void**, void*);
};
...
struct Converter<Il2CppString*>
{
    ...
    static Il2CppString* toCpp(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value)
    {
        ...
        size_t bufsize = 0;
        auto str = apis->get_value_string_utf16(env, value, nullptr, &bufsize);
        if (str)
        {
        ...
        str = apis->get_value_string_utf16(env, value, buff.data(), &bufsize);
        if (str)
        {
            buff[bufsize] = '\0';
            return il2cpp::vm::String::NewUtf16(reinterpret_cast<const Il2CppChar *>(str), bufsize);
...
struct Params
{
    ...
    {
        auto firstVal = apis->get_arg(info, start);
        if (DataTransfer::IsAssignable(apis, env, firstVal, typeId, false))
        {
            return DataTransfer::GetPointer<Il2CppArray>(apis, env, firstVal);
        }
...
{
    static pesapi_value toScript(struct pesapi_ffi* apis, pesapi_env env, Il2CppClass* typeId, T* ptr)
    {
        if (ptr->hasValue)
        {
            return CSValueTypePtrToJsValue(apis, env, il2cpp::vm::Class::GetNullableArgument(typeId), std::addressof(ptr->p1));
        }
        else
        {
            return apis->create_null(env);
    ...
    static void toCpp(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value, Il2CppClass* typeId, T* ptr)
    {
        ptr->hasValue = GetValueTypeFromJs(apis, env, value, il2cpp::vm::Class::GetNullableArgument(typeId), std::addressof(ptr->p1));
    }
};
