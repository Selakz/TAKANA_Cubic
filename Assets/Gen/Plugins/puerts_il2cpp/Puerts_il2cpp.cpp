...
{
    return (type && il2cpp::vm::Class::IsAssignableFrom(il2cpp_defaults.systemtype_class, type->klass)) ? il2cpp_codegen_class_from_type(((Il2CppReflectionType *)type)->type) : nullptr;
}
...
static bool IsPtrToSelf(const Il2CppType* type, const Il2CppClass* selfClass)
{
    if (type->byref && (type->type == IL2CPP_TYPE_VALUETYPE || type->type == IL2CPP_TYPE_TYPEDBYREF))
    {
        ...
        return il2cpp::vm::Class::FromIl2CppType(&(klass->byval_arg)) == selfClass;
    }
...
static std::string GetTypeSignature(const Il2CppType* type)
{
    ...
    case IL2CPP_TYPE_TYPEDBYREF://public ref struct TypedReference {}
    {
        ...
        if (Type::IsEnum(type) || il2cpp::vm::Class::GetParent(klass) == il2cpp_defaults.enum_class)
        {
...
static bool HasParamArray(const MethodInfo* method)
{
    ...
    Il2CppMetadataCustomAttributeHandle attributeHandle = MetadataCache::GetCustomAttributeTypeToken(methodWithParameterAttributeInformation->klass->image, il2cpp::vm::Method::GetParameterToken(method, method->parameters_count - 1));
    return Reflection::HasAttribute(attributeHandle, s_ParamArrayAttribute);
#else
    return (MetadataCache::HasAttribute(methodWithParameterAttributeInformation->klass->image, il2cpp::vm::Method::GetParameterToken(method, method->parameters_count - 1), s_ParamArrayAttribute));
#endif
}

static std::string GetParameterSignature(const MethodInfo* method, int index, bool isBridge)
{
    ...
    if (type)
    {
        if (!isBridge && (type->attrs & PARAM_ATTRIBUTE_OPTIONAL)) {
            return "D" + GetTypeSignature(type);
        }

        if ((index == method->parameters_count - 1) && HasParamArray(method))
        {
            Il2CppClass* parameterKlass = il2cpp::vm::Class::FromIl2CppType(type, false);
...
{
    return il2cpp::vm::Class::HasParent(klass, il2cpp_defaults.delegate_class) && klass != il2cpp_defaults.delegate_class && klass != il2cpp_defaults.multicastdelegate_class;
}
...
static std::string GetMethodSignature(const MethodInfo* method, bool isBridge, bool isExtensionMethod)
{
    ...
    if (IsCtor(method))
    {
        ...
        {
            signature += GetParameterSignature(method, i, isBridge);
        }
    }
    else
    {
        signature += GetTypeSignature(method->return_type);
        if (!isBridge && il2cpp::vm::Method::IsInstance(method)) signature += (il2cpp_defaults.object_class == method->klass) ? "T" : "t";
        for (uint32_t i = 0; i < method->parameters_count; ++i)
        {
...
Il2CppClass* GetReturnType(const MethodInfo* method) {
    ...
    return il2cpp::vm::Class::FromIl2CppType(il2cpp::vm::Method::GetReturnType(method), false);
}
...
const MethodInfo* FindOrCreateMethodInfo(const MethodInfo* invoke, Il2CppMethodPointer methodPointer, InvokerMethod invokerMethod)
{
    const MethodInfo* method = NULL;
    {
        ...
        {
#ifdef TUANJIE_1_1_OR_NEWER
            MethodInfo* newMethod = (MethodInfo*)IL2CPP_CALLOC(1, sizeof(MethodInfo), IL2CPP_MEM_il2cpp_alloc);
#else
            MethodInfo* newMethod = (MethodInfo*)IL2CPP_CALLOC(1, sizeof(MethodInfo));
#endif
            newMethod->name = invoke->name;
            newMethod->klass = invoke->klass;
            newMethod->methodPointer = methodPointer;
            newMethod->virtualMethodPointer = methodPointer;
            newMethod->invoker_method = invokerMethod;
...
static void* DelegateAllocate(Il2CppClass *klass, BridgeFuncInfo* bridgeFuncs, PObjectRefInfo** outTargetData, Il2CppObject* target)
{
    const MethodInfo* invoke = il2cpp::vm::Runtime::GetDelegateInvoke(klass);
    Il2CppDelegate* delegate = (Il2CppDelegate*)il2cpp::vm::Object::New(klass);
    const MethodInfo* bridgeMethodInfo = FindOrCreateMethodInfo(invoke, bridgeFuncs->Method, bridgeFuncs->Invoker);
    Type::ConstructDelegate(delegate, target, bridgeMethodInfo);
...
void SetGlobalType_ScriptObject(Il2CppReflectionType *type)
{
    if (!type)
    {
        Exception::Raise(Exception::GetInvalidOperationException("type of ScriptObject is null"));
    }
...
static void MethodCallback(struct pesapi_ffi* apis, pesapi_callback_info info)
{
    ...
    try 
    {
        ...
        {
            self = apis->get_native_holder_ptr(info);
        ...
        while(*wrapDatas)
        {
            Il2CppMethodPointer methodPointer = (*wrapDatas)->MethodPointer;
            const MethodInfo* method = (*wrapDatas)->Method;
            if ((method->flags & METHOD_ATTRIBUTE_VIRTUAL) && self)
            {
                Il2CppClass* thisType = method->klass;
                Il2CppObject* obj = (Il2CppObject*)self;

                if (!il2cpp::vm::Class::IsValuetype(thisType))
                {
                    method = il2cpp::vm::Object::GetVirtualMethod(obj, method);
                    methodPointer = method->methodPointer;
                }
            }
            if ((*wrapDatas)->Wrap(apis, (MethodInfo*)method, methodPointer, info, env, self, checkArgument, *wrapDatas))
            {
                return;
            }
            ++wrapDatas;
        }
        std::string err_info = "invalid arguments to ";
        err_info += csharpMethodInfo->Name;
    ...
    catch (Il2CppExceptionWrapper& exception)
    {
        ...
        {
            std::string err_info = "unknow c# execption for ";
            err_info += csharpMethodInfo->Name;
            apis->throw_by_string(info, err_info.c_str());
        }
        else
...
static void GetterCallback(struct pesapi_ffi* apis, pesapi_callback_info info)
{
    ...
    catch (Il2CppExceptionWrapper& exception)
    {
        ...
        if (outException != NULL)
        {
            std::string err_info = "unknow c# execption for getter of ";
            err_info += wrapData->FieldInfo->name;
            apis->throw_by_string(info, err_info.c_str());
        }
        else
        {
...
static void SetterCallback(struct pesapi_ffi* apis, pesapi_callback_info info)
{
    ...
    catch (Il2CppExceptionWrapper& exception)
    {
        ...
        if (outException != NULL)
        {
            std::string err_info = "unknow c# execption for setter of ";
            err_info += wrapData->FieldInfo->name;
            apis->throw_by_string(info, err_info.c_str());
        }
        else
...
#endif
    return (defaultValue && il2cpp::vm::Class::IsValuetype(il2cpp::vm::Class::FromIl2CppType(il2cpp::vm::Method::GetParam(method, index), false))) ? Object::Unbox(defaultValue) : defaultValue;
}
...
static void* CtorCallback(struct pesapi_ffi* apis, pesapi_callback_info info)
{
    ...
    try
    {
        ...
        {
            std::string err_info = "invalid arguments for constructor of ";
            err_info += classInfo->TypeId->name;
            apis->throw_by_string(info, err_info.c_str());
        }
    ...
    catch (Il2CppExceptionWrapper& exception)
    {
        ...
        if (outException != NULL)
        {
            std::string err_info = "unknow c# execption for constructor of ";
            err_info += classInfo->TypeId->name;
            apis->throw_by_string(info, err_info.c_str());
        }
        else
...
static Il2CppGCHandle* FindOrCreateHandleStoreOfValue(struct pesapi_ffi* apis, pesapi_env env, pesapi_value value, pesapi_value_ref* out_value_ref, Il2CppObject** out_object)
{
    ...
    if (!res)
    {
        value_ref = apis->create_value_ref(env, value, internal_field_count_for_gc_handle);
        
        *out_object = nullptr;
        if (apis->set_private(env, value, value_ref))
        {
            res = reinterpret_cast<Il2CppGCHandle*>(apis->get_ref_internal_fields(value_ref, &field_count));
    ...
    else
    {
        *out_object = il2cpp::gc::GCHandle::GetTarget(*res);
        ...
        if (*out_object == nullptr) // gc了，但还没经过CleanupPendingKillScriptObjects释放
        {
...
static Il2CppObject* FunctionToDelegate(struct pesapi_ffi* apis, pesapi_env env, pesapi_value jsval, JsClassInfoHeader* classInfo)
{
    ...
    Il2CppGCHandle* handle_store = FindOrCreateHandleStoreOfValue(apis, env, jsval, &value_ref, &target);
    ...
    if (target == nullptr)
    {
        ...
        target = il2cpp::vm::Object::New(delegateInfoClass);
    }

    PObjectRefInfo* delegateInfo;
    Il2CppObject* ret = (Il2CppObject *)DelegateAllocate(classInfo->TypeId, classInfo->BridgeFuncs, &delegateInfo, target);
    auto targetHandle = il2cpp::gc::GCHandle::GetTargetHandle(target, 0, il2cpp::gc::HANDLE_WEAK);
...
{
    pesapi_env env = apis->get_env(info);
    pesapi_value jsval = apis->get_arg(info, 0);
    if (!apis->is_function(env, jsval))
    {
        apis->throw_by_string(info, "expect a function");
        return nullptr;
    }
...
pesapi_value TryTranslateBuiltin(struct pesapi_ffi* apis, pesapi_env env, Il2CppObject* obj)
{
    if (obj)
    {
        if (obj->klass == g_typeofPersistentObjectInfo)
        {
            ...
            if (apis != objectInfo->Apis)
            {
                Exception::Raise(Exception::GetInvalidOperationException("ScriptObject form other papi provider!"));
            }
            pesapi_env_ref envRef = apis->get_ref_associated_env(objectInfo->ValueRef);
            auto scope = apis->open_scope(envRef);
            auto objEnv = apis->get_env_from_ref(envRef);
            bool invalidObj = (objEnv == nullptr) || apis->get_env_private(objEnv) != apis->get_env_private(env);
            apis->close_scope(scope);
            if (!envRef || !objEnv)
            {
                Exception::Raise(Exception::GetInvalidOperationException("ScriptObject env is invalid!"));
            }
            if (invalidObj)
            {
                Exception::Raise(Exception::GetInvalidOperationException("ScriptObject own by anther env!"));
            }
        ...
        if (obj->klass == g_typeofArrayBuffer)
        {
            ...
            return apis->create_binary_by_value(env, Array::GetFirstElementAddress(buffer), (size_t)length);
        }
    }
    return nullptr;
}
...
static pesapi_value TryTranslatePrimitiveWithClass(struct pesapi_ffi* apis, pesapi_env env, Il2CppObject* obj, Il2CppClass *klass = nullptr)
{
    if (obj)
    {
        const Il2CppType *type = il2cpp::vm::Class::GetType(klass ? klass : obj->klass);
        if (type->type == IL2CPP_TYPE_STRING)
        {
            ...
            return apis->create_string_utf16(env, reinterpret_cast<const uint16_t *>(utf16), utf16len);
        }
...
pesapi_value TranslateValueType(struct pesapi_ffi* apis, pesapi_env env, Il2CppClass* targetClass, Il2CppObject* obj)
{
    ...
    return DataTransfer::CopyValueType(apis, env, targetClass, Object::Unbox(obj), len);
}
...
pesapi_value TryTranslateValueType(struct pesapi_ffi* apis, pesapi_env env, Il2CppObject* obj)
{
    if (obj && obj->klass)
    {
        ...
        if (il2cpp::vm::Class::IsValuetype(objClass))
        {
...
handle_underlying:
    switch (t)
    {
        case IL2CPP_TYPE_I1:
        {
            data.i1 = (int8_t)apis->get_value_int32(env, jsval);
            break;
        }
        case IL2CPP_TYPE_BOOLEAN:
        {
            data.u1 = (uint8_t)apis->get_value_bool(env, jsval);
        }
        case IL2CPP_TYPE_U1:
        {
            data.u1 = (uint8_t)apis->get_value_uint32(env, jsval);
            break;
        }
        case IL2CPP_TYPE_I2:
        {
            data.i2 = (int16_t)apis->get_value_int32(env, jsval);
            break;
        }
        case IL2CPP_TYPE_U2:
        {
            data.u2 = (uint16_t)apis->get_value_uint32(env, jsval);
            break;
        }
        case IL2CPP_TYPE_CHAR:
        {
            data.c = (Il2CppChar)apis->get_value_uint32(env, jsval);
            break;
        }
#if IL2CPP_SIZEOF_VOID_P == 4
        case IL2CPP_TYPE_I:
        ...
        case IL2CPP_TYPE_I4:
        {
            data.i4 = (int32_t)apis->get_value_int32(env, jsval);
            break;
        }
#if IL2CPP_SIZEOF_VOID_P == 4
        case IL2CPP_TYPE_U:
        ...
        case IL2CPP_TYPE_U4:
        {
            data.u4 = (uint32_t)apis->get_value_uint32(env, jsval);
            break;
        }
#if IL2CPP_SIZEOF_VOID_P == 8
        case IL2CPP_TYPE_I:
        ...
        case IL2CPP_TYPE_I8:
        {
            data.i8 = apis->get_value_int64(env, jsval);
            break;
        }
#if IL2CPP_SIZEOF_VOID_P == 8
        case IL2CPP_TYPE_U:
        ...
        case IL2CPP_TYPE_U8:
        {
            data.u8 = apis->get_value_uint64(env, jsval);
            break;
        }
        case IL2CPP_TYPE_R4:
        {
            data.r4 = (float)apis->get_value_double(env, jsval);
            break;
        }
        case IL2CPP_TYPE_R8:
        {
            data.r8 = apis->get_value_double(env, jsval);
            break;
        }
        case IL2CPP_TYPE_STRING:
        {
            if (apis->is_null(env, jsval) || apis->is_undefined(env, jsval))
            {
                return nullptr;
            }
            size_t bufsize = 0;
            auto str = apis->get_value_string_utf16(env, jsval, nullptr, &bufsize);
            if (str)
            {
            ...
            str = apis->get_value_string_utf16(env, jsval, buff.data(), &bufsize);
            if (str)
            {
                buff[bufsize] = '\0';
                return (Il2CppObject*)il2cpp::vm::String::NewUtf16(reinterpret_cast<const Il2CppChar *>(str), bufsize);
        ...
        case IL2CPP_TYPE_PTR:
        {
            if (apis->is_function(env, jsval))
            {
                if (IsDelegate(klass))
                {
                    JsClassInfoHeader* jsClassInfo = (JsClassInfoHeader*)g_registry_api->get_class_data(g_registry, klass, true);
                    if (!jsClassInfo)
                    {
                        Exception::Raise(Exception::GetInvalidOperationException("can't find type info for delegate"));
                    }
                    else if (!jsClassInfo->BridgeFuncs)
                    {
                        std::string err_info = "can't find DelegateBridge for delegate, sig:";
                        
                        MethodInfo* invoke = (MethodInfo*)il2cpp::vm::Class::GetMethodFromName(jsClassInfo->TypeId, "Invoke", -1);
                        err_info +=  GetMethodSignature(invoke, true, false);
                        
                        Exception::Raise(Exception::GetInvalidOperationException(err_info.c_str()));
                    }
                    return FunctionToDelegate(apis, env, jsval, jsClassInfo);
                }
            }
            auto ptr = apis->get_native_object_ptr(env, jsval);
            if (!ptr)
            {
                if ((klass == g_typeofPersistentObjectInfo || klass == il2cpp_defaults.object_class) && apis->is_object(env, jsval))
                {
                ...
                if ((klass == g_typeofArrayBuffer || klass == il2cpp_defaults.object_class) && apis->is_binary(env, jsval)) 
                {
                    ...
                    void* data;
                    size_t length;
                    data = apis->get_value_binary(env, jsval, &length);
            ...
            auto objClass = (Il2CppClass *)apis->get_native_object_typeid(env, jsval);
            if (klass == il2cpp_defaults.object_class && g_typeofTypedValue && il2cpp::vm::Class::IsAssignableFrom(g_typeofTypedValue, objClass))
            {
            ...
            if (il2cpp::vm::Class::IsAssignableFrom(klass, objClass))
            {
                return il2cpp::vm::Class::IsValuetype(objClass) ? DataTransfer::GetValueTypeForCSharp(objClass, ptr) : (Il2CppObject*)ptr;
            }
            else if(objClass)
            {
                std::string message = "expect ";
                message += klass->name;
                message += ", by got ";
                message += objClass->name;
        ...
        case IL2CPP_TYPE_VALUETYPE:
            ...
            {
                t = il2cpp::vm::Class::GetEnumBaseType(Type::GetClass(type))->type;
                goto handle_underlying;
            }
            else
            {
                ...
                toBox = apis->get_native_object_ptr(env, jsval);
                if (!toBox)
                {
...
{
    if (!il2cpp::vm::Class::IsAssignableFrom(s_UnityEngineObjectClass, obj->klass))
    {
        return false;
    }
...
pesapi_value CSRefToJsValue(struct pesapi_ffi* apis, pesapi_env env, Il2CppClass *targetClass, Il2CppObject* obj)
{
    ...
    if (!obj) return apis->create_null(env);
    ...
    if ((targetClass == il2cpp_defaults.object_class) && il2cpp::vm::Class::IsEnum(obj->klass))
    {
        targetClass = il2cpp::vm::Class::GetElementClass(obj->klass);
    }
    else if (il2cpp::vm::Class::IsEnum(targetClass))
    {
        targetClass = il2cpp::vm::Class::GetElementClass(targetClass);
    }
    ...
    if (il2cpp::vm::Class::IsValuetype(targetClass))
    {
...
pesapi_value CSValueTypePtrToJsValue(struct pesapi_ffi* apis, pesapi_env env, Il2CppClass* targetClass, void* ptr)
{
    ...
    bool isNullable = il2cpp::vm::Class::IsNullable(targetClass);
    ...
    if (isNullable)
    {
        ...
        ptr = valueStart;
        targetClass = il2cpp::vm::Class::GetNullableArgument(targetClass);
    }

    if (il2cpp::vm::Class::IsEnum(targetClass))
    {
        targetClass = il2cpp::vm::Class::GetElementClass(targetClass);
    }
    const Il2CppType* type = il2cpp::vm::Class::GetType(targetClass);
...
static bool GetValueTypeFromJsInternal(struct pesapi_ffi* apis, pesapi_env env, pesapi_value jsValue, Il2CppClass* klass, void* storage, bool forceConvert)
{
    bool hasValue = false;
    uint32_t valueSize = klass->instance_size - sizeof(Il2CppObject);
    if (!jsValue) return false;
    void* ptr = apis->get_native_object_ptr(env, jsValue);
    if (ptr)
    {
        auto objClass = (Il2CppClass*) apis->get_native_object_typeid(env, jsValue);
        if (il2cpp::vm::Class::IsAssignableFrom(klass, objClass))
        {
            hasValue = true;
...
handle_underlying:
        switch (t)
        {
            case IL2CPP_TYPE_I1:
            {
                if (forceConvert || apis->is_int32(env, jsValue))
                {
                    data.i1 = (int8_t)apis->get_value_int32(env, jsValue);
                    hasValue = true;
                }
                break;
            }
            case IL2CPP_TYPE_BOOLEAN:
            {
                if (forceConvert || apis->is_boolean(env, jsValue))
                {
                    data.u1 = (uint8_t)apis->get_value_bool(env, jsValue);
                    hasValue = true;
                }
                break;
            }
            case IL2CPP_TYPE_U1:
            {
                if (forceConvert || apis->is_uint32(env, jsValue))
                {
                    data.u1 = (uint8_t)apis->get_value_uint32(env, jsValue);
                    hasValue = true;
                }
                break;
            }
            case IL2CPP_TYPE_I2:
            {
                if (forceConvert || apis->is_int32(env, jsValue))
                {
                    data.i2 = (int16_t)apis->get_value_int32(env, jsValue);
                    hasValue = true;
                }
                break;
            }
            case IL2CPP_TYPE_U2:
            {
                if (forceConvert || apis->is_uint32(env, jsValue))
                {
                    data.u2 = (uint16_t)apis->get_value_uint32(env, jsValue);
                    hasValue = true;
                }
                break;
            }
            case IL2CPP_TYPE_CHAR:
            {
                if (forceConvert || apis->is_uint32(env, jsValue))
                {
                    data.c = (Il2CppChar)apis->get_value_uint32(env, jsValue);
                    hasValue = true;
                }
                break;
            }
            ...
            case IL2CPP_TYPE_I4:
            {
                if (forceConvert || apis->is_int32(env, jsValue))
                {
                    data.i4 = (int32_t)apis->get_value_int32(env, jsValue);
                    hasValue = true;
                }
                break;
            }
            ...
            case IL2CPP_TYPE_U4:
            {
                if (forceConvert || apis->is_uint32(env, jsValue))
                {
                    data.u4 = (uint32_t)apis->get_value_uint32(env, jsValue);
                    hasValue = true;
                }
                break;
            }
            ...
            case IL2CPP_TYPE_I8:
            {
                if (forceConvert || apis->is_int64(env, jsValue))
                {
                    data.i8 = apis->get_value_int64(env, jsValue);
                    hasValue = true;
                }
                break;
            }   
            ...
            case IL2CPP_TYPE_U8:
            {
                if (forceConvert || apis->is_uint64(env, jsValue))
                {
                    data.u8 = apis->get_value_uint64(env, jsValue);
                    hasValue = true;
                }
                break;
            }
            case IL2CPP_TYPE_R4:
            {
                if (forceConvert || apis->is_double(env, jsValue))
                {
                    data.r4 = (float)apis->get_value_double(env, jsValue);
                    hasValue = true;
                }
                break;
            }
            case IL2CPP_TYPE_R8:
            {
                if (forceConvert || apis->is_double(env, jsValue))
                {
                    data.r8 = apis->get_value_double(env, jsValue);
                    hasValue = true;
                }
                break;
            }
...
bool GetValueTypeFromJs(struct pesapi_ffi* apis, pesapi_env env, pesapi_value jsValue, Il2CppClass* klass, void* storage)
{
    return GetValueTypeFromJsInternal(apis, env, jsValue, klass, storage, false);
}

bool GetValueTypeFromJsForceConvert(struct pesapi_ffi* apis, pesapi_env env, pesapi_value jsValue, Il2CppClass* klass, void* storage)
{
    return GetValueTypeFromJsInternal(apis, env, jsValue, klass, storage, true);
}

static pesapi_value JsObjectUnRef(struct pesapi_ffi* apis, pesapi_env env, pesapi_value jsValue)
{
    return (apis->is_boxed_value(env, jsValue)) ?  apis->unboxing(env, jsValue) : nullptr;
}

static void JsObjectSetRef(struct pesapi_ffi* apis, pesapi_env env, pesapi_value outer, pesapi_value val)
{
    if (outer && val && apis->is_boxed_value(env, outer))
    {
        apis->update_boxed_value(env, outer, val);
    }
}
...
static bool ReflectionWrapper(struct pesapi_ffi* apis, MethodInfo* method, Il2CppMethodPointer methodPointer, pesapi_callback_info info, pesapi_env env, void* self, bool checkJSArgument, WrapData* wrapData)
{
    ...
    if (checkJSArgument || wrapData->OptionalNum > 0)
    {
        ...
        else if(!hasParamArray && wrapData->OptionalNum > 0)
        {
            if (js_args_len > method->parameters_count - csArgStart)
            {
                return false;
        ...
        for (int i = csArgStart; i < method->parameters_count; ++i)
        {
            ...
            Il2CppClass* parameterKlass = il2cpp::vm::Class::FromIl2CppType(parameterType);
            il2cpp::vm::Class::Init(parameterKlass);
            pesapi_value jsValue = apis->get_arg(info, i - csArgStart);
            
            if ((hasDefault || (isLastArgument && hasParamArray)) && apis->is_undefined(env, jsValue))
            {
                continue;
            }
            if (passedByReference)
            {
                if (apis->is_object(env, jsValue))
                {
                    continue;
                }
                else
            ...
            if (isLastArgument && hasParamArray)
            {
                ...
                parameterKlass = parameterKlass->element_class;
            }
            else
...
handle_underlying:
            switch (t)
            {
                ...
                case IL2CPP_TYPE_BOOLEAN:
                {
                    if (!apis->is_boolean(env, jsValue))
                    {
                        return false;
                    }
                    break;
                ...
                case IL2CPP_TYPE_STRING:
                {
                    if (!apis->is_string(env, jsValue) && !apis->is_null(env, jsValue) && !apis->is_undefined(env, jsValue))
                    {
                        return false;
                    }
                    break;
                ...
                case IL2CPP_TYPE_PTR:
                {
                    if (apis->is_function(env, jsValue) && DataTransfer::IsDelegate(parameterKlass))
                    {
                        continue;
                    }
                    ...
                    auto ptr = apis->get_native_object_ptr(env, jsValue);
                    if (ptr)
                    {
                        auto objClass = (Il2CppClass *)apis->get_native_object_typeid(env, jsValue);
                        if (!il2cpp::vm::Class::IsAssignableFrom(parameterKlass, objClass))
                        {
                            return false;
                        }
                    }
                    else if (!apis->is_null(env, jsValue) && !apis->is_undefined(env, jsValue))
                    {
                        return false;
                    }
                ...
                case IL2CPP_TYPE_VALUETYPE:
                    ...
                    {
                        t = il2cpp::vm::Class::GetEnumBaseType(Type::GetClass(parameterType))->type;
                        goto handle_underlying;
                    }
                    else
                    {
                        auto objClass = (Il2CppClass *)apis->get_native_object_typeid(env, jsValue);
                        if (!objClass || !il2cpp::vm::Class::IsAssignableFrom(parameterKlass, objClass))
                        {
                            return false;
                        }
                    }
                    break;
                case IL2CPP_TYPE_GENERICINST:
                    if (il2cpp::vm::Class::IsNullable(parameterKlass))
                    {
                        if (apis->is_null(env, jsValue) || apis->is_undefined(env, jsValue))
                        {
                            continue;
                        }
                        parameterKlass = il2cpp::vm::Class::GetNullableArgument(parameterKlass);
                        parameterType = &parameterKlass->byval_arg;
                        t = parameterType->type;
                        goto handle_underlying;
                    }
    ...
    {
        args[0] = apis->get_native_holder_ptr(info);
    }
    ...
    for (int i = csArgStart; i < method->parameters_count; ++i) 
    {
        ...
        if (isLastArgument && hasParamArray)
        {
            ...
            pesapi_value firstVal = apis->get_arg(info, jsParamStart);
            if (firstVal)
            {
                auto objClass  = (Il2CppClass *)apis->get_native_object_typeid(env, firstVal);
                if (objClass && Class::IsAssignableFrom(parameterKlass, objClass))
                {
                    args[i] = apis->get_native_object_ptr(env, firstVal);
                    continue;
                }
            }
            auto elementType = il2cpp::vm::Class::FromIl2CppType(&parameterKlass->element_class->byval_arg);
            auto arrayLen = js_args_len - jsParamStart > 0 ? js_args_len - jsParamStart : 0;
            auto array = Array::NewSpecific(parameterKlass, arrayLen);
            if (il2cpp::vm::Class::IsValuetype(elementType))
            {
                ...
                {
                    GetValueTypeFromJs(apis, env, apis->get_arg(info, j), elementType, addr + valueSize * (j - i + csArgStart));
                }
            }
            else
            {
                for(int j = jsParamStart; j < js_args_len; ++j)
                {
                    il2cpp_array_setref(array, j - i + csArgStart, JsValueToCSRef(apis, elementType, env, apis->get_arg(info, j)));
                }
            }
            args[i] = array;
            continue;
        ...
        if (il2cpp::vm::Class::IsValuetype(parameterKlass))
        {
            if (il2cpp::vm::Class::IsNullable(parameterKlass))
            {
                void* storage = alloca(parameterKlass->instance_size - sizeof(Il2CppObject));
                auto underlyClass = il2cpp::vm::Class::GetNullableArgument(parameterKlass);
                uint32_t valueSize = underlyClass->instance_size - sizeof(Il2CppObject);
                
#ifndef UNITY_2021_1_OR_NEWER
                uint8_t* dataPtr = static_cast<uint8_t*>(storage);
#else
                int32_t nullableShift = parameterKlass->fields[1].offset - sizeof(Il2CppObject);
                uint8_t* dataPtr = static_cast<uint8_t*>(storage) + nullableShift;
#endif
                bool hasValue = GetValueTypeFromJs(apis, env, jsValue, underlyClass, dataPtr);
#ifndef UNITY_2021_1_OR_NEWER
            ...
            {
                auto underlyClass = il2cpp::vm::Class::FromIl2CppType(&parameterKlass->byval_arg);
            ...
            else if (hasDefault && apis->is_undefined(env, jsValue))
            {
            ...
            else
            {
                ...
                bool hasValue = GetValueTypeFromJsForceConvert(apis, env, jsValue, parameterKlass, storage);
                if (!hasValue)
                {
                    memset(storage, 0, valueSize);
                }
        ...
        else if (passedByReference)
        {
            ...
            *arg = nullptr;
            ...
            if (jsValue)
            {
                ...
                {
                    auto objClass = (Il2CppClass *)apis->get_native_object_typeid(env, jsValue);
                    if (il2cpp::vm::Class::IsAssignableFrom(underlyClass, objClass))
                    {
                        *arg = ptr;
                    }
                }
        ...
        {
            auto underlyClass = il2cpp::vm::Class::FromIl2CppType(&parameterKlass->element_class->byval_arg);
            void* storage = alloca(underlyClass->instance_size - sizeof(Il2CppObject));
            jsValue = JsObjectUnRef(apis, env, jsValue);
        ...
        {
            args[i] = (hasDefault && apis->is_undefined(env, jsValue)) ? GetDefaultValuePtr(method, i): JsValueToCSRef(apis, parameterKlass, env, jsValue);
        }
    }
    ...
    Il2CppClass* returnType = il2cpp::vm::Class::FromIl2CppType(method->return_type);
    ...
    else
    {
        ...
        {
            il2cpp::vm::Class::Init(returnType);
        ...
        else
        {
            ...
            {
                if (il2cpp::vm::Class::IsValuetype(returnType))
                {
                    returnIsValueType = true;
                }
                else
    ...
    for (int i = csArgStart; i < method->parameters_count; ++i)
    {
        ...
        if (il2cpp::vm::Class::IsValuetype(parameterKlass) && passedByReference)
        {
            if (il2cpp::vm::Class::IsNullable(parameterKlass))
            {
#ifndef UNITY_2021_1_OR_NEWER
                ...
                if (!hasValue)
                {
                    JsObjectSetRef(apis, env, jsValue, apis->create_null(env));
                    continue;
                }
            }
            auto underlyClass = il2cpp::vm::Class::FromIl2CppType(&parameterKlass->byval_arg);
...
static void ReflectionGetFieldWrapper(struct pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* field, size_t offset, Il2CppClass* fieldType)
{
    ...
    if (!(field->type->attrs & FIELD_ATTRIBUTE_STATIC))
    {
        csThis = apis->get_native_holder_ptr(info);
    }
    
    if (il2cpp::vm::Class::IsValuetype(fieldType))
    {
        void* storage = nullptr;
        auto expectType = fieldType;
        
        if (il2cpp::vm::Class::IsEnum(fieldType))
        {
            expectType = il2cpp::vm::Class::GetElementClass(fieldType);
        }
        
        if ((field->type->attrs & FIELD_ATTRIBUTE_STATIC))
        {
            int t = il2cpp::vm::Class::GetType(fieldType)->type;
            //il2cpp-blob.h
        ...
        if (il2cpp::vm::Class::IsNullable(fieldType)) // nullable先用nullable类型获取字段内容后，再偏移
        {
            if (!NullableHasValue(fieldType, storage))
            {
                apis->add_return(info, apis->create_null(env));
                return;
            }
            expectType = il2cpp::vm::Class::GetNullableArgument(fieldType);
            int32_t nullableShift = fieldType->fields[1].offset - sizeof(Il2CppObject);
            storage = ((char*)storage) + nullableShift;
        }
        ...
        if (!jsVal) 
        {
            ...
            jsVal = DataTransfer::CopyValueType(apis, env, expectType, storage, valueSize);
        }
        
        if (jsVal)
        {
            apis->add_return(info, jsVal);
        }
    }
    else
    {
        void* storage = nullptr;
        GetFieldValue(csThis, field, offset, &storage);
        apis->add_return(info, CSRefToJsValue(apis, env, fieldType, (Il2CppObject*)storage));
    }
}
...
static void ReflectionSetFieldWrapper(struct pesapi_ffi* apis, pesapi_callback_info info, FieldInfo* field, size_t offset, Il2CppClass* fieldType)
{
    ...
    pesapi_value jsValue = apis->get_arg(info, 0);
    if (il2cpp::vm::Class::IsValuetype(fieldType))
    {
        if (il2cpp::vm::Class::IsNullable(fieldType))
        {
            void* storage = alloca(fieldType->instance_size - sizeof(Il2CppObject));
            auto underlyClass = il2cpp::vm::Class::GetNullableArgument(fieldType);
            uint32_t valueSize = underlyClass->instance_size - sizeof(Il2CppObject);
            int32_t nullableShift = fieldType->fields[1].offset - sizeof(Il2CppObject);
            bool hasValue = GetValueTypeFromJs(apis, env, jsValue, underlyClass, ((char*)storage) + nullableShift);
#ifndef UNITY_2021_1_OR_NEWER
            *(static_cast<uint8_t*>(storage) + valueSize) = hasValue;
#else
            *(static_cast<uint8_t*>(storage)) = hasValue;
...
Il2CppObject* ScriptObjectGetValue(Il2CppObject* scriptObject, struct pesapi_ffi* apis, Il2CppString* key, Il2CppReflectionType* rtype)
{
    PObjectRefInfo* objectInfo = GetPObjectRefInfo(scriptObject);
    ...
    auto val = apis->get_property(env, obj, key_std.c_str());
    if (!val)
    {
        return nullptr;
    }
...
Il2CppObject* EvalInternal(struct pesapi_ffi* apis, intptr_t ptr, Il2CppArray * __code, Il2CppString* __path, Il2CppReflectionType *__type)
{
    ...
    AutoValueScope ValueScope(apis, envRef);
    auto env = apis->get_env_from_ref(envRef);
    apis->set_registry(env, g_registry);
    ...
    auto ret = apis->eval(env, code, codeSize, path.c_str());
    
    if (apis->has_caught(ValueScope.scope()))
    {
        Exception::Raise(Exception::GetInvalidOperationException(apis->get_exception_as_string(ValueScope.scope(), true)));
        return nullptr;
    }
    if (__type)
    {
...
void SetObjectToGlobal(struct pesapi_ffi* apis, pesapi_env_ref envRef, Il2CppString* __key, Il2CppObject *obj)
{
    ...
    pesapi_value global = apis->global(env);
    if (global)
    {
        apis->set_property(env, global, key.c_str(), CSRefToJsValue(apis, env, obj->klass, obj));
    }
}

Il2CppObject* PValueToCSharp(struct pesapi_ffi* apis, pesapi_env env, pesapi_value val, Il2CppReflectionType* rtype)
{
    auto type = il2cpp_codegen_class_from_type(rtype->type);
    return JsValueToCSRef(apis, type, env, val);
}
    ...
    void CleanupPendingKillScriptObjects()
    {
        ...
        for (const auto& valueRef : pendingKillRefs)
        {
            ...
            if (nullptr == il2cpp::gc::GCHandle::GetTarget(handle)) //假如不为空代表已经重新被绑定了
            {
                ...
                pesapi_value val = apis->get_value_from_ref(env, valueRef);
...
static void* OnCsObjectEnter(void* ptr, JsClassInfo* classInfo, JsEnvPrivate* jsEnvPrivate)
{
    ...
    if (classInfo->IsValueType)
    {
        ...
        {
            return reinterpret_cast<void*>(jsEnvPrivate->RefCSObject(((Il2CppObject*)ptr) - 1));
        }
        return nullptr;
    }
    else
    {
        return reinterpret_cast<void*>(jsEnvPrivate->RefCSObject((Il2CppObject*)ptr));
    }
}

static void OnCsObjectExit(void* ptr, JsClassInfo* classInfo, JsEnvPrivate* jsEnvPrivate, void* userdata)
{
    if (!classInfo) return;
...
{
    return klass != il2cpp_defaults.void_class && !IsPrimitive(type->type) && IL2CPP_TYPE_ENUM != type->type && !Type::IsEnum(type) && il2cpp::vm::Class::GetParent(klass) != il2cpp_defaults.enum_class;
}
...
static WrapData* CreateOverloadData(const MethodInfo* method, bool isExtensionMethod)
{
    ...
    try
    {
        if (overloadData->MethodPointer && (!method->has_full_generic_sharing_signature || !method->is_inflated))
        {
...
static void createFunctionWrapper(struct pesapi_ffi* apis, pesapi_callback_info info)
{
    ...
    for (int i = 0; i < argc; ++i)
    {
        ...
        if (!reflectionMethod || !il2cpp::vm::Class::IsAssignableFrom(il2cpp_defaults.method_info_class, reflectionMethod->object.klass))
        {
    ...
    if (csharpMethodInfo)
    {
        ...
        auto func = apis->create_function(env, MethodCallback, csharpMethodInfo, FunctioFinalize);
...
puerts::JsEnvPrivate* InitialPapiEnvRef(struct pesapi_ffi* apis, pesapi_env_ref envRef, Il2CppObject *objPool, Il2CppReflectionMethod* objPoolAddMethodInfo, Il2CppReflectionMethod* objPoolRemoveMethodInfo)
{
    ...
    if (loadType && createFunction)
    {
        ...
        if (global)
        {
            ...
            g_registry_api->on_class_not_found(g_registry, ClassNotFoundCallback);
            return jsEnvPrivate;
        }
    }
...
{
    Il2CppClass** constraints = il2cpp::vm::Class::GetOrCreateMonoGenericParameterInfo(gparam)->constraints;
    ...
    if (constraints)
    {
        for (int i = 0; constraints[i]; ++i)
        {
            ...
            if (il2cpp::vm::Class::IsInterface(constraint))
                continue;
...
static bool RegisterType(Il2CppClass* klass)
{
    ...
    if (g_registry_api->get_class_data(g_registry, klass, false))
    {
        return true;
    }
    ...
    classInfo->SuperTypeId = il2cpp::vm::Class::GetParent(klass);
    classInfo->IsValueType = il2cpp::vm::Class::IsValuetype(klass);
    ...
    auto AddMethod = [&](const MethodInfo* method, bool isGetter, bool isSetter, const char* name) -> bool
    {
        ...
        bool isExtensionMethod = method->klass != klass && IsExtensionMethod(method);
        bool isStatic = !il2cpp::vm::Method::IsInstance(method) && !isExtensionMethod; 
    ...
    if (isDelegate)
    {
        ...
        try
        {
            ...
            classInfo->BridgeFuncs = FindBridgeFunc(signature.c_str());
            if (!classInfo->BridgeFuncs)
            {
                signature = "";
                auto IsSharedable = [](const Il2CppType* type) -> bool
                    {
                        if (type->byref) return false;
                        if (type->type == IL2CPP_TYPE_VOID) return true;
                        Il2CppClass* paramClass = il2cpp::vm::Class::FromIl2CppType(type, false);
                        il2cpp::vm::Class::Init(paramClass);
                        if (il2cpp::vm::Class::IsValuetype(paramClass)) return false;
                        return true;
                    };

                if (IsSharedable(invoke->return_type))
                {
                    signature += invoke->return_type->type == IL2CPP_TYPE_VOID ? "v" : "o";
                    bool isParamsSharedable = true;
                    for (uint32_t i = 0; i < invoke->parameters_count; ++i)
                    {
                        const Il2CppType* type = il2cpp::vm::Method::GetParam(invoke, i);
                        if (!IsSharedable(type))
                        {
                            isParamsSharedable = false;
                            break;
                        }
                        signature += "o";
                    }
                    if (isParamsSharedable && signature.size() <= 10)
                    {
                        classInfo->BridgeFuncs = FindBridgeFunc(signature.c_str());
                    }
                }
    ...
    else
    {
        ...
        if (etype != IL2CPP_TYPE_SZARRAY && etype != IL2CPP_TYPE_ARRAY)
        {
            ...
            for (uint16_t i = 0; i < klass->field_count; i++)
            {
                ...
                if ((field->type->attrs & FIELD_ATTRIBUTE_FIELD_ACCESS_MASK) != FIELD_ATTRIBUTE_PUBLIC) continue;
                ...
                fieldData->Offset = (int32_t)il2cpp::vm::Field::GetOffset(field) - (il2cpp::vm::Class::IsValuetype(il2cpp::vm::Field::GetParent(field)) ? sizeof(Il2CppObject) : 0);;
                fieldData->TypeInfo = il2cpp::vm::Class::FromIl2CppType(field->type, false);;

                classInfo->Fields.push_back({ isStatic, fieldData });
            }
        }
    ...
    g_registry_api->define_class(g_registry, classInfo->TypeId, classInfo->SuperTypeId, nullptr, classInfo->TypeId->name,
        classInfo->BridgeFuncs ? &DelegateCtorCallback : &CtorCallback, classInfo->IsValueType && !classInfo->TypeId->has_references ? &PApiFree : (pesapi_finalize)nullptr, classInfo, false);
    ...
    g_registry_api->set_property_info_size(g_registry, classInfo->TypeId, instanceMethodCount, staticMethodCount, instancePropertyCount, staticPropertyCount);
    ...
    for (auto const& method : methods)
    {
        g_registry_api->set_method_info(
            g_registry, classInfo->TypeId, method->IsStatic ? smidx++ : imidx++, method->Name, method->IsStatic, &MethodCallback, method, false);
    }

    for (auto const& kv : gseters)
    {
        auto geter_or_setter = kv.second.first ? kv.second.first : kv.second.second;
        g_registry_api->set_property_info(g_registry, classInfo->TypeId, geter_or_setter->IsStatic ? spidx++ : ipidx++, geter_or_setter->Name, geter_or_setter->IsStatic,
    ...
    for (auto& field : classInfo->Fields)
    {
        g_registry_api->set_property_info(g_registry, classInfo->TypeId, field.IsStatic ? spidx++ : ipidx++, field.Data->FieldInfo->name, field.IsStatic,
            GetterCallback, SetterCallback, field.Data, field.Data, false);
    }
    
    g_registry_api->trace_native_object_lifecycle(g_registry, classInfo->TypeId, (pesapi_on_native_object_enter)&OnCsObjectEnter, (pesapi_on_native_object_exit)&OnCsObjectExit);
...
void InitialPuerts(pesapi_registry_api* registry_api, pesapi_registry registry)
{
    ...
    InternalCalls::Add("Puerts.NativeAPI::SetGlobalType_ScriptObject(System.Type)", (Il2CppMethodPointer)puerts::SetGlobalType_ScriptObject);
    ...
    InternalCalls::Add("Puerts.NativeAPI::PValueToCSharp(System.IntPtr,System.IntPtr,System.IntPtr,System.Type)", (Il2CppMethodPointer)puerts::PValueToCSharp);
    ...
    InternalCalls::Add("Puerts.ScriptObject::GetValue(System.IntPtr,System.String,System.Type)", (Il2CppMethodPointer)puerts::ScriptObjectGetValue);
    ...
    puerts::g_registry_api = registry_api;
    puerts::g_registry = registry;
    ...
    puerts::s_UnityEngineObjectClass = il2cpp::vm::Class::FromName(il2cpp::vm::Assembly::GetImage(il2cpp::vm::Assembly::Load("UnityEngine.dll")), "UnityEngine", "Object");
    IL2CPP_ASSERT(puerts::s_UnityEngineObjectClass);
    puerts::s_UnityEngineObjectOpEqualityMethodInfo = Class::GetMethodFromName(puerts::s_UnityEngineObjectClass, "op_Equality", 2);
    IL2CPP_ASSERT(puerts::s_UnityEngineObjectOpEqualityMethodInfo);
}
...
void AddPendingKillScriptObjects(struct pesapi_ffi* apis, puerts::JsEnvPrivate* jsEnvPrivate, pesapi_value_ref valueRef)
{
    ...
    if (!apis->env_ref_is_valid(envRef)) // jsEnv已经释放
    {
        apis->release_value_ref(valueRef);
        return;
    }
